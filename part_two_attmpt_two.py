...
excel_list = [
    'market-movers-active.xlsx',
    'market-movers-large-cap.xlsx',
    'market-movers-losers.xlsx',
    # 'market-movers-most-volatile.xlsx',
    # 'market-movers-overbought.xlsx',
    # 'market-movers-oversold.xlsx',
]

for excel_file in excel_list:
    oscillators_df = pandas.read_excel(excel_file, sheet_name = 7)
